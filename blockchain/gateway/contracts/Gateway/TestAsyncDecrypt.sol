...
contract TestAsyncDecrypt is GatewayCaller {
    ...
    function requestBoolInfinite() public {
        ...
        Oracle.requestDecryption(
            cts,
            this.callbackBoolInfinite.selector,
            0,
            block.timestamp + 100
        );
    }
    ...
    ) public onlyGateway returns (uint16) {
    ...
    function requestUint32(uint32 input1, uint32 input2) public {
        ...
        uint256 requestID = Oracle.requestDecryption(
            cts,
    ...
    ) public onlyGateway returns (uint32) {
        uint256[] memory params = getParamsUint(requestID);
        unchecked {
            uint32 result = uint32(params[0]) +
                uint32(params[1]) +
                decryptedInput;
            yUint32 = result;
            return result;
    ...
    function requestSeveralAddresses() public {
        ...
        Oracle.requestDecryption(
            cts,
            this.callbackAddresses.selector,
            0,
            block.timestamp + 100
        );
    }
    ...
    function callbackMixed(
        ...
        yUint64 = decUint64_1;
        require(
            decUint64_1 == decUint64_2 && decUint64_2 == decUint64_3,
            "Wrong decryption"
        );
        yAddress = decAddress;
        return yUint4;
