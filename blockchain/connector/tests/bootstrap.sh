...
sleep 1
echo $PASSWORD | wasmd tx wasm instantiate 1 '{"key":"foo", "value": "bar", "proof_type": "debug"}' --label "configuration_0" --from validator --output json --chain-id testing --node tcp://kms-full-node:26657 -y --no-admin
