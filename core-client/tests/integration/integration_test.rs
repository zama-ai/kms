...
///
/// # Note
/// Uses Default FHE parameters (production-like, slower than Test params) without the default
/// epoch, so the servers boot with signing material only.
///
/// # Example
/// ```no_run
/// let (material_dir, _servers, config_path) =
...
///
/// Uses `FheParameter::Default` with the fixture's default epoch.
///
/// Signing, client, and default-epoch material come from the party-count-specific fixture root
/// under `test-material/default`; FHE material is generated by the test.
