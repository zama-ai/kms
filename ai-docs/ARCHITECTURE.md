...
Complete FHE key writes reject an existing public key or private entry at the requested epoch
before writing any material. They cannot combine an old pair half with newly generated keys
