...
///
/// Used in [`crate::endpoints::decryption::run_decryption_bitdec`]
...
///
/// Used in [`crate::endpoints::decryption::run_decryption_noiseflood`]
#[async_trait]
...
///
/// Used in [`crate::endpoints::keygen::distributed_keygen`]
#[async_trait]
pub trait DKGPreprocessing<Z: Ring>: BasePreprocessing<Z> + BitPreprocessing<Z> {
    ...
    /// Fill the noise from [`crate::online::secret_distributions::SecretDistributions`]
