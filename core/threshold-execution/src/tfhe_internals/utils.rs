...
pub fn expanded_encrypt<M: HlCompactable + Numeric, T: HlExpandable + Tagged>(
    ...
    use crate::tfhe_internals::utils;
...
pub mod tests {
    ...
    fn reconstruct_bit_vec_from_glwe_share_enum<const EXTENSION_DEGREE: usize>(
        input: HashMap<
            Role,
            crate::tfhe_internals::private_keysets::GlweSecretKeyShareEnum<EXTENSION_DEGREE>,
        >,
        expected_num_bits: usize,
        threshold: usize,
    ) -> Vec<u64>
        ...
        ResiduePoly<Z128, EXTENSION_DEGREE>: ErrorCorrect,
    {
        ...
        match some_val {
            crate::tfhe_internals::private_keysets::GlweSecretKeyShareEnum::Z64(_share) => {
            ...
            crate::tfhe_internals::private_keysets::GlweSecretKeyShareEnum::Z128(_share) => {
                let input: HashMap<_, _> = input
                    .into_iter()
        ...
        ResiduePoly<Z128, EXTENSION_DEGREE>: Ring,
    {
        ...
        for (role, sk) in sk_shares {
            ...
            match sk.lwe_compute_secret_key_share {
                crate::tfhe_internals::private_keysets::LweSecretKeyShareEnum::Z64(inner) => {
                    for key_share in inner.data.into_iter() {
                        (*lwe_key_shares).push(key_share);
                    }
                }
                crate::tfhe_internals::private_keysets::LweSecretKeyShareEnum::Z128(inner) => {
                    for key_share in inner.data.into_iter() {
