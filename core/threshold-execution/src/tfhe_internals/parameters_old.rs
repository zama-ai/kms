...
use tfhe::{
    ...
    shortint::{
        AtomicPatternParameters, CarryModulus, ClassicPBSParameters, EncryptionKeyChoice,
        MaxNoiseLevel, MessageModulus, PBSOrder, PBSParameters,
        parameters::{
            Backend, CompactCiphertextListExpansionKind, CompactPublicKeyEncryptionParameters,
            CompressionParameters, DecompositionBaseLog, DecompositionLevelCount, GlweDimension,
            LweCiphertextCount, LweDimension, MetaNoiseSquashingParameters, MetaParameters,
            ...
            RSigmaFactor, ReRandomizationConfiguration, ShortintKeySwitchingParameters,
...
use crate::{
    keyset_config::{KeyGenSecretKeyConfig, KeySetConfig},
    tfhe_internals::parameters::{
        BKParams, DKGParams, DistributedCompressionParameters, DistributedSnsCompressionParameters,
        DkgMode, DkgParamsAvailable, EncryptionType, KSKParams, MSNRKConfiguration, MSNRKParams,
        NoiseBounds, NoiseInfo, SecretKeyDeviations, TUniformBound, combine_noise_info,
        compute_min_trials, compute_prob_hw_within_range,
    },
};

#[expect(clippy::large_enum_variant)]
#[derive(Clone, Copy, Serialize, Deserialize, Debug, PartialEq)]
pub enum DKGParamsOld {
...
impl From<DKGParamsOld> for PBSParameters {
    fn from(val: DKGParamsOld) -> Self {
        PBSParameters::PBS(val.get_params_basics_handle().to_classic_pbs_parameters())
    }
}

impl TryFrom<DKGParamsOld> for DKGParamsSnS {
    type Error = anyhow::Error;

    fn try_from(value: DKGParamsOld) -> Result<Self, Self::Error> {
        match value {
            DKGParamsOld::WithSnS(params) => Ok(params),
            DKGParamsOld::WithoutSnS(_) => Err(anyhow::anyhow!("Cannot convert to SnS params")),
        }
    }
}

impl TryFrom<DKGParamsOld> for DKGParamsRegular {
    type Error = anyhow::Error;

    fn try_from(value: DKGParamsOld) -> Result<Self, Self::Error> {
        match value {
            DKGParamsOld::WithSnS(_) => Err(anyhow::anyhow!("Cannot convert to SnS params")),
            DKGParamsOld::WithoutSnS(params) => Ok(params),
        }
    }
}
...
impl DKGParamsOld {
    ...
    pub fn get_params_without_sns(&self) -> DKGParamsOld {
        match self {
            Self::WithSnS(params) => DKGParamsOld::WithoutSnS(params.regular_params),
    ...
    pub fn to_tfhe_config(&self) -> tfhe::Config {
        ...
        let noise_squashing_params = match self {
            DKGParamsOld::WithoutSnS(_) => None,
            DKGParamsOld::WithSnS(dkg_sns) => {
...
pub trait DKGParamsBasics: Sync {
    ...
    fn to_dkg_params(&self) -> DKGParamsOld;
...
impl DkgParamsAvailable {
    pub fn to_old_version(&self) -> DKGParamsOld {
        match self {
            DkgParamsAvailable::NIST_PARAMS_P32_NO_SNS_FGLWE => NIST_PARAMS_P32_NO_SNS_FGLWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P32_SNS_FGLWE => NIST_PARAMS_P32_SNS_FGLWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P8_NO_SNS_FGLWE => NIST_PARAMS_P8_NO_SNS_FGLWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P8_SNS_FGLWE => NIST_PARAMS_P8_SNS_FGLWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P32_NO_SNS_LWE => NIST_PARAMS_P32_NO_SNS_LWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P32_SNS_LWE => NIST_PARAMS_P32_SNS_LWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P8_NO_SNS_LWE => NIST_PARAMS_P8_NO_SNS_LWE_OLD,
            DkgParamsAvailable::NIST_PARAMS_P8_SNS_LWE => NIST_PARAMS_P8_SNS_LWE_OLD,
            DkgParamsAvailable::BC_PARAMS_NO_SNS => BC_PARAMS_NO_SNS_OLD,
            DkgParamsAvailable::BC_PARAMS_SNS => BC_PARAMS_SNS_OLD,
            DkgParamsAvailable::BC_PARAMS_NIGEL_NO_SNS => BC_PARAMS_NIGEL_NO_SNS_OLD,
            DkgParamsAvailable::BC_PARAMS_NIGEL_SNS => BC_PARAMS_NIGEL_SNS_OLD,
            DkgParamsAvailable::PARAMS_TEST_BK_SNS => PARAMS_TEST_BK_SNS_OLD,
        }
    }
}

/// Blockchain Parameters (with pfail `2^-128`), using parameters in tfhe-rs codebase
pub const BC_PARAMS_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
    ciphertext_parameters:
        tfhe::shortint::parameters::current_params::V1_6_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    dedicated_compact_public_key_parameters: Some((
        tfhe::shortint::parameters::current_params::V1_6_PARAM_PKE_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
        tfhe::shortint::parameters::current_params::V1_6_PARAM_KEYSWITCH_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    )),
    compression_decompression_parameters: Some(
        tfhe::shortint::parameters::current_params::V1_6_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128
    ),
    secret_key_deviations: None,
    cpk_re_randomization_ksk_params: Some(tfhe::shortint::parameters::current_params::V1_6_PARAM_KEYSWITCH_PKE_TO_BIG_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128),
};

/// Blockchain Parameters without SnS (with pfail `2^-128`), using parameters in tfhe-rs codebase
pub const BC_PARAMS_NO_SNS_OLD: DKGParamsOld = DKGParamsOld::WithoutSnS(BC_PARAMS_OLD);
...
pub const BC_PARAMS_SNS_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: BC_PARAMS_OLD,
    sns_params: tfhe::shortint::parameters::current_params::V1_6_NOISE_SQUASHING_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128,
    sns_compression_params: Some(tfhe::shortint::parameters::current_params::V1_6_NOISE_SQUASHING_COMP_PARAM_MESSAGE_2_CARRY_2_KS_PBS_TUNIFORM_2M128),
});
...
const BC_PARAMS_NIGEL_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
...
pub const BC_PARAMS_NIGEL_NO_SNS_OLD: DKGParamsOld = DKGParamsOld::WithoutSnS(BC_PARAMS_NIGEL_OLD);
...
pub const BC_PARAMS_NIGEL_SNS_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: BC_PARAMS_NIGEL_OLD,
...
pub const PARAMS_TEST_BK_SNS_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
...
pub const NIST_PARAMS_P8_INTERNAL_LWE_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
    ciphertext_parameters:
...
pub const NIST_PARAMS_P8_NO_SNS_LWE_OLD: DKGParamsOld =
    DKGParamsOld::WithoutSnS(NIST_PARAMS_P8_INTERNAL_LWE_OLD);

pub const NIST_PARAMS_P8_SNS_LWE_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: NIST_PARAMS_P8_INTERNAL_LWE_OLD,
    sns_params:
        super::raw_parameters::NIST_PARAMS_NOISE_SQUASHING_MESSAGE_1_CARRY_1_PBS_KS_TUNIFORM_2M128,
    sns_compression_params: None,
});

pub const NIST_PARAMS_P32_INTERNAL_LWE_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
    ciphertext_parameters:
...
pub const NIST_PARAMS_P32_NO_SNS_LWE_OLD: DKGParamsOld =
    DKGParamsOld::WithoutSnS(NIST_PARAMS_P32_INTERNAL_LWE_OLD);

pub const NIST_PARAMS_P32_SNS_LWE_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: NIST_PARAMS_P32_INTERNAL_LWE_OLD,
    sns_params:
        super::raw_parameters::NIST_PARAMS_NOISE_SQUASHING_MESSAGE_2_CARRY_2_PBS_KS_TUNIFORM_2M128,
    sns_compression_params: None,
});

pub const NIST_PARAMS_P8_INTERNAL_FGLWE_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
    ciphertext_parameters:
...
pub const NIST_PARAMS_P8_NO_SNS_FGLWE_OLD: DKGParamsOld =
    DKGParamsOld::WithoutSnS(NIST_PARAMS_P8_INTERNAL_FGLWE_OLD);

// Parameters for SwitchSquash
pub const NIST_PARAMS_P8_SNS_FGLWE_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: NIST_PARAMS_P8_INTERNAL_FGLWE_OLD,
    sns_params:
        super::raw_parameters::NIST_PARAMS_NOISE_SQUASHING_MESSAGE_1_CARRY_1_KS_PBS_TUNIFORM_2M128,
    sns_compression_params: None,
});

pub const NIST_PARAMS_P32_INTERNAL_FGLWE_OLD: DKGParamsRegular = DKGParamsRegular {
    dkg_mode: DkgMode::Z128,
    sec: 128,
    ciphertext_parameters:
...
pub const NIST_PARAMS_P32_NO_SNS_FGLWE_OLD: DKGParamsOld =
    DKGParamsOld::WithoutSnS(NIST_PARAMS_P32_INTERNAL_FGLWE_OLD);

// Parameters for SwitchSquash
pub const NIST_PARAMS_P32_SNS_FGLWE_OLD: DKGParamsOld = DKGParamsOld::WithSnS(DKGParamsSnS {
    regular_params: NIST_PARAMS_P32_INTERNAL_FGLWE_OLD,
    sns_params:
...
impl From<DKGParamsOld> for DKGParams {
    fn from(old: DKGParamsOld) -> Self {
        match old {
            DKGParamsOld::WithoutSnS(regular) => Self::from_regular(regular, None),
            DKGParamsOld::WithSnS(sns) => {
...
mod tests {
    use crate::{
        ...
        tfhe_internals::parameters_old::{
            BC_PARAMS_SNS_OLD, compute_min_trials, compute_prob_hw_within_range,
        },
    };

    use super::{BC_PARAMS_NO_SNS_OLD, DKGParamsOld, DkgParamsAvailable};
    ...
    fn test_required_preproc() {
        let keyset_config = KeySetConfig::default();
        // Note that BC_PARAMS_NO_SNS_OLD doesn't have fixed HW
        // so sk_num_bits_to_sample == sk_num_bits
        let param = BC_PARAMS_NO_SNS_OLD;
    ...
    fn test_required_preproc_sns() {
        let keyset_config = KeySetConfig::default();
        let param = BC_PARAMS_SNS_OLD;
        let sns_param = match param {
            crate::tfhe_internals::parameters_old::DKGParamsOld::WithSnS(p) => p,
    ...
    fn test_required_preproc_decompression() {
        ...
        for param in [BC_PARAMS_SNS_OLD, BC_PARAMS_NO_SNS_OLD] {
            let h = param.get_params_basics_handle();
            let sk_total = 0;
            assert_eq!(sk_total, h.num_raw_bits(keyset_config));
    ...
    fn test_required_preproc_use_existing_with_legacy_oprf_share() {
        ...
        // BC_PARAMS_NO_SNS_OLD samples unconstrained binary secret keys, so one LWE
    ...
    fn check_no_panic() {
        for param in DkgParamsAvailable::iter() {
            ...
            if let DKGParamsOld::WithSnS(sns_params) = p {
