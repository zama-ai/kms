...
cfg_if::cfg_if! {
    if #[cfg(feature = "non-wasm")] {
        ...
        /// Maximum PRSS values generated by one awaited Rayon submission.
        /// Env: `MPC_PRSS_MAX_SUBMISSION` (default 3000, clamped to at least one).
        pub(crate) static PRSS_MAX_SUBMISSION: std::sync::LazyLock<usize> =
            std::sync::LazyLock::new(|| env_usize("MPC_PRSS_MAX_SUBMISSION", 3000).max(1));
