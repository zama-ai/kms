    ...
    LargeOfflineStrategyZ128: Preprocessing<ResiduePoly<Z128, EXTENSION_DEGREE>, LargeSession>,
{
    ...
    async fn prss_init(
        ...
        let role_assignment: HashMap<Role, Identity> =
            bc2wrap::deserialize_unsafe(&request.role_assignment).map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
        ...
        let prss_params: PrssInitParams =
            bc2wrap::deserialize_unsafe(&request.params).map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
    ...
    async fn preproc_key_gen(
        ...
        let preproc_params: PreprocKeyGenParams = bc2wrap::deserialize_unsafe(&request.params)
            .map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
    ...
    async fn threshold_key_gen(
        ...
        let kg_params: ThresholdKeyGenParams = bc2wrap::deserialize_unsafe(&request.params)
            .map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
    ...
    async fn preproc_decrypt(
        ...
        let preproc_params: PreprocDecryptParams = bc2wrap::deserialize_unsafe(&request.params)
            .map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
    ...
    async fn threshold_decrypt(
        ...
        let decrypt_params: ThresholdDecryptParams = bc2wrap::deserialize_unsafe(&request.params)
            .map_err(|e| {
            tonic::Status::new(
                tonic::Code::Aborted,
    ...
    async fn threshold_decrypt_result(
        ...
        let request = request.into_inner();
        let session_id = bc2wrap::deserialize_unsafe(&request.request_id).map_err(|e| {
            tonic::Status::new(
                tonic::Code::Aborted,
    ...
    async fn crs_gen_result(
        ...
        let session_id: SessionId =
            bc2wrap::deserialize_unsafe(&request.request_id).map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Aborted,
                    format!("Error deserializing session_id: {e}"),
                )
    ...
    async fn status_check(
        ...
        let request = request.into_inner();
        let sid: SessionId = bc2wrap::deserialize_unsafe(&request.request_id).map_err(|e| {
            tonic::Status::new(
                tonic::Code::Aborted,
                format!("Error deserializing session_id: {e}"),
            )
