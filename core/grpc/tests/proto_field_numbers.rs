...
/// Field numbers that have never been used, and must not be: 10 was skipped when the Solana
/// identity was added. Recording it keeps the gap deliberate rather than an accident waiting to be
/// tidied up by someone who assumes numbering is cosmetic.
const RESERVED_GAPS: &[u32] = &[10];
