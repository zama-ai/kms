...
// `TestingUserDecryptionTranscript::to_stable_test_vector` on the Rust side) instead of the
// non-stable `TestingUserDecryptionTranscript` bincode blob. Every field of the JSON maps
// directly onto an argument of the stable public WASM API, so an older published `tkms`/
// `node-tkms` build can be exercised against a vector generated by a newer KMS.
