...
async fn test_complete_session_notification() {
    ...
    for j in 1..=1 {
        ...
        tokio::time::sleep(tokio::time::Duration::from_secs(wait_time + 2)).await;
