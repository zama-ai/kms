...
async fn test_key_gen_centralized() -> Result<()> {
...
#[tokio::test(flavor = "multi_thread", worker_threads = 8)]
async fn test_decompression_key_gen_centralized() -> Result<()> {
...
async fn default_key_gen_centralized() -> Result<()> {
...
#[cfg(feature = "slow_tests")]
#[tokio::test(flavor = "multi_thread", worker_threads = 8)]
async fn default_decompression_key_gen_centralized() -> Result<()> {
    decompression_key_gen_centralized(
        FheParameter::Default,
...
async fn decompression_key_gen_centralized(params: FheParameter, test_name: &str) -> Result<()> {
...
#[cfg(feature = "slow_tests")]
#[tokio::test(flavor = "multi_thread", worker_threads = 8)]
async fn test_compressed_key_gen_centralized() -> Result<()> {
