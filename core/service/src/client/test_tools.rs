...
>(
    ...
    // a vector of sender that will trigger shutdown of core/threshold-experiments servers
        ...
        itertools::izip!(1..=num_parties, mpc_listeners.into_iter(), vaults)
    {
        ...
        // create channels that will trigger core/threshold-experiments shutdown
