...
#[tonic::async_trait]
impl<PubS, PrivS> CoreServiceEndpoint for ThresholdKms<PubS, PrivS>
where
    ...
    PrivS: StorageExt + Send + Sync + 'static,
{
    ...
    async fn partial_key_gen_preproc(
        ...
        METRICS.increment_request_counter(OP_KEYGEN_PREPROC_REQUEST);
        self.keygen_preprocessor
            .partial_key_gen_preproc(request)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn insecure_key_gen_preproc(
        ...
        self.keygen_preprocessor
            .insecure_key_gen_preproc(request)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn abort_key_gen(&self, request: Request<RequestId>) -> Result<Response<Empty>, Status> {
        ...
        let preproc_id =
            parse_grpc_request_id(&request.into_inner(), RequestIdParsingErr::KeyGenAbort)?;
        ...
        self.keygen_preprocessor
            .abort_key_gen_preproc(preproc_id, key_gen_abort_res)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn insecure_crs_gen(
        ...
        self.insecure_crs_generator
            .insecure_crs_gen(request)
            .await
            .map_err(|e| e.into())
    }
    ...
    async fn destroy_mpc_context(
        ...
        let epochs_destroyed = self
            .epoch_manager
            .destroy_epochs_for_context(&context_id)
            .await
            .map_err(Status::from)?;
    ...
    async fn get_health_status(
        ...
        own_material.preprocessing_ids =
            self.keygen_preprocessor.get_all_preprocessing_ids().await?;

        let health_check_sessions = self
            .session_maker
            .get_healthcheck_session_all_contexts()
            .await
            .map_err(|e| {
                tonic::Status::internal(format!("Failed to get health check sessions: {}", e))
            })?;
