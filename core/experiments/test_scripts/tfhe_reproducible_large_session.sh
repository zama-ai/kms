...
$MOBYGO_EXEC -c $1 preproc-key-gen --dkg-params $PARAMS --num-sessions 5 --session-type large --sid $CURR_SID --seed $SEED
#Checking every 30s
...
EXPECTED_HASH="27e6f17fd5f9daeb7244d7572f1654d6f95043bc883f439e14eb62cbe8983e6e"
