...
static EXCEPTIONAL_SET_STORE_5_128: LazyLock<RwLock<ExceptionalSetMap<ResiduePolyF5Z128>>> =
    LazyLock::new(|| RwLock::new(HashMap::new()));
static EXCEPTIONAL_SET_STORE_5_64: LazyLock<RwLock<ExceptionalSetMap<ResiduePolyF5Z64>>> =
    LazyLock::new(|| RwLock::new(HashMap::new()));
...
static MONOMIALS_F5_Z64: LazyLock<Vec<ResiduePoly<Z64, 5>>> = LazyLock::new(|| {
    (0..5)
        .map(|i| {
...
static MONOMIALS_F5_Z128: LazyLock<Vec<ResiduePoly<Z128, 5>>> = LazyLock::new(|| {
    (0..5)
        .map(|i| {
...
mod tests {
    ...
    fn two_power_sunshine() {
        ...
        let powers = crate::galois_fields::gf32::two_powers(input, 8);
