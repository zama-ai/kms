...
static EXCEPTIONAL_SET_STORE_7_128: LazyLock<RwLock<ExceptionalSetMap<ResiduePolyF7Z128>>> =
    LazyLock::new(|| RwLock::new(HashMap::new()));
static EXCEPTIONAL_SET_STORE_7_64: LazyLock<RwLock<ExceptionalSetMap<ResiduePolyF7Z64>>> =
    LazyLock::new(|| RwLock::new(HashMap::new()));
...
static MONOMIALS_F7_Z64: LazyLock<Vec<ResiduePoly<Z64, 7>>> = LazyLock::new(|| {
    (0..7)
        .map(|i| {
...
static MONOMIALS_F7_Z128: LazyLock<Vec<ResiduePoly<Z128, 7>>> = LazyLock::new(|| {
    (0..7)
        .map(|i| {
...
mod tests {
    ...
    use crate::{
        PRSSConversions,
        base_ring::{Z64, Z128},
        galois_rings::common::{SyndromeContext, TryFromWrapper, pack_residue_poly},
        poly::Poly,
        sharing::{
    ...
    fn two_power_sunshine() {
        ...
        let powers = crate::galois_fields::gf128::two_powers(input, 8);
