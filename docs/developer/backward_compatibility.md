...
To re-generate the data, run the binary in the generation crate:
...
1. Then you run `cd backward-compatibility/generate-v0.11 && cargo run --release` as described above to generate new testing objects
