...
```bash
cargo run --bin kms-gen-keys -F testing -F threshold-experiments/testing -- centralized
cargo run --bin kms-gen-keys -F testing -F threshold-experiments/testing -- threshold
```
