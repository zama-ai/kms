...
3. **Update** `backward-compatibility/generate-v0.13/Cargo.toml`:
   - Update package name to `backward-compatibility-generate-v0.13`
...
| Generator Crate | KMS Versions | Serde Version | Status |
|----------------|--------------|---------------|--------|
| `generate-v0.11` | v0.11.x, v0.12.x | 1.0.210-1.0.226 | ✅ Active |
| `generate-v0.13` | v0.13.x+ | 2.0.x | 🚧 Future (when needed) |
...
# For v0.13+ (if incompatible generator exists)
cd backward-compatibility/generate-v0.13
cargo run --release
```
