//! Data generation for kms-core v0.11.1
//! This file provides the code that is used to generate all the data to serialize and versionize
//! for kms-core v0.11.1

use aes_prng::AesRng;
use kms_0_11_1::cryptography::internal_crypto_types::gen_sig_keys;
use kms_0_11_1::engine::base::KmsFheKeyHandles;
use kms_0_11_1::engine::centralized::central_kms::generate_client_fhe_key;
use kms_0_11_1::engine::threshold::service::ThresholdFheKeys;
use kms_0_11_1::util::key_setup::FhePublicKey;
...
use threshold_fhe_0_11_1::algebra::galois_rings::degree_4::{ResiduePolyF4Z128, ResiduePolyF4Z64};
use threshold_fhe_0_11_1::execution::small_execution::prf::PrfKey;
use threshold_fhe_0_11_1::execution::tfhe_internals::public_keysets::FhePubKeySet;
...
use kms_grpc_0_11_1::kms::v1::TypedPlaintext;
...
impl KmsV0_11 {
    ...
    fn gen_kms_fhe_key_handles(dir: &PathBuf) -> TestMetadataKMS {
        ...
        let key_id = kms_grpc_0_11_1::RequestId::zeros();
        let preproc_id = kms_grpc_0_11_1::RequestId::zeros();
    ...
    fn gen_threshold_fhe_keys(dir: &PathBuf) -> TestMetadataKMS {
        ...
        let threshold_fhe_keys = ThresholdFheKeys {
            ...
            meta_data: kms_0_11_1::engine::base::KeyGenMetadata::LegacyV0(info),
...
impl KMSCoreVersion for V0_11 {
    const VERSION_NUMBER: &'static str = "0.11.1";
